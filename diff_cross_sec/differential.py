...
def main(RandGenSEED, Number, Ms, COME, MinMass, MaxMass, yMax, PDFSet, PDFScale, Coupling, CouplingScale, StringCoeff, SecondStringCoeff, QCDCoeff, dMass, uMass, sMass, cMass, bMass, tMass, gg2gg, gg2qqbar, gq2gq, gqbar2gqbar, qqbar2gg, gg2gGamma, gq2qGamma, mass):
    ...
    sumgggg      = Integrate(MonteCarlogggg, (mass, 21, 21), MC, -Ymax, Ymax, yMax)
    gg2gg_k = sumgggg

    sumggqqbar   = Integrate(MonteCarloggqqbar, (mass, 21, 21), MC, -Ymax, Ymax, yMax)
    gg2qqbar_k = sumggqqbar

    sumgdgd = Integrate(MonteCarlogqgq, (mass, 21, 1), MC, -Ymax, Ymax, yMax)
    sumgugu = Integrate(MonteCarlogqgq, (mass, 21, 2), MC, -Ymax, Ymax, yMax)
    sumgsgs = Integrate(MonteCarlogqgq, (mass, 21, 3), MC, -Ymax, Ymax, yMax)
    sumgcgc = Integrate(MonteCarlogqgq, (mass, 21, 4), MC, -Ymax, Ymax, yMax)
    sumgbgb = Integrate(MonteCarlogqgq, (mass, 21, 5), MC, -Ymax, Ymax, yMax)
    sumgtgt = Integrate(MonteCarlogqgq, (mass, 21, 6), MC, -Ymax, Ymax, yMax)
    
    gq2gq_k = sumgdgd + sumgugu + sumgsgs + sumgcgc + sumgbgb + sumgtgt
    
    
    sumgdbargdbar = Integrate(MonteCarlogqbargqbar, (mass, 21, -1), MC, -Ymax, Ymax, yMax)
    sumgubargubar = Integrate(MonteCarlogqbargqbar, (mass, 21, -2), MC, -Ymax, Ymax, yMax)
    sumgsbargsbar = Integrate(MonteCarlogqbargqbar, (mass, 21, -3), MC, -Ymax, Ymax, yMax)
    sumgcbargcbar = Integrate(MonteCarlogqbargqbar, (mass, 21, -4), MC, -Ymax, Ymax, yMax)
    sumgbbargbbar = Integrate(MonteCarlogqbargqbar, (mass, 21, -5), MC, -Ymax, Ymax, yMax)
    sumgtbargtbar = Integrate(MonteCarlogqbargqbar, (mass, 21, -6), MC, -Ymax, Ymax, yMax)
    
    gqbar2gqbar_k = sumgdbargdbar + sumgubargubar + sumgsbargsbar + sumgcbargcbar + sumgbbargbbar + sumgtbargtbar

    sumddbargg = Integrate(MonteCarloqqbargg, (mass, 1, -1), MC, -Ymax, Ymax, yMax)
    sumuubargg = Integrate(MonteCarloqqbargg, (mass, 2, -2), MC, -Ymax, Ymax, yMax)
    sumssbargg = Integrate(MonteCarloqqbargg, (mass, 3, -3), MC, -Ymax, Ymax, yMax)
    sumccbargg = Integrate(MonteCarloqqbargg, (mass, 4, -4), MC, -Ymax, Ymax, yMax)
    sumbbbargg = Integrate(MonteCarloqqbargg, (mass, 5, -5), MC, -Ymax, Ymax, yMax)
    sumttbargg = Integrate(MonteCarloqqbargg, (mass, 6, -6), MC, -Ymax, Ymax, yMax)
...
if checker() == True:
    ...
    for mass in range(lowerBound, upperBound, stepSize):
    ...
    with open("./gg2gg5.txt", "a") as file:
        for s in gg2gg:
            file.write("%s\n" % s)
        
        
    with open("./gg2qqbar5.txt", "a") as file:
        for s in gg2qqbar:
            file.write("%s\n" % s)
        
    with open("./gq2gq5.txt", "a") as file:
        for s in gq2gq:
            file.write("%s\n" % s)
        
    with open("./gqbar2gqbar5.txt", "a") as file:
